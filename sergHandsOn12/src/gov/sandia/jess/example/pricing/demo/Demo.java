...
public class Demo {
	...
	public static void main(String[] args) {
		try {
			...
			// Orders HandsOn11
                        ...
                        processOrder(database, engine, 777);
			processOrder(database, engine, 888);
			processOrder(database, engine, 999);
	...
	private static void processOrder(DemoDatabase database, PricingEngine engine, int orderNumber)
